...
class PygameRenderer:
    ...
    def render_challenge_info(self, challenge_data: Dict) -> None:
        ...
        # Description
        desc_text = challenge_data['description']
        ...
        if challenge_data['time_limit']:
            ...
            progress_width = int(bar_width * challenge_data['time_progress'])
            pygame.draw.rect(self.screen, (0, 150, 0), (x, y, progress_width, bar_height))
