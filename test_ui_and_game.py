...
def test_dropper():
    ...
    h2so4 = Chemical("H2SO4", [("H", 2), ("S", 1), ("O", 4)], 0.0, "#FF0000", -813, "liquid")
...
def test_challenge():
    ...
    chem1 = Chemical("Acid", [("H", 1), ("Cl", 1)], 1.0, "#FF0000", -100, "aqueous")
    chem2 = Chemical("Base", [("Na", 1), ("O", 1), ("H", 1)], 1.0, "#0000FF", 100, "aqueous")
